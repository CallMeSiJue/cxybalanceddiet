...
public class PlayerTempSL extends PersistentState {
    ...
    public static PlayerTempSL createFromNbt(NbtCompound tag) {
        ...
        playersNbt.getKeys().forEach(key -> {
            ...
            playerTempState.thirstValue = playersNbt.getCompound(key).getDouble(ThirstManager.NBT_VALUE);
    ...
    public static PlayerTempSL getServerState(MinecraftServer server) {
        ...
        PlayerTempSL state = persistentStateManager.getOrCreate(type, Cxybalanceddiet.MOD_ID);
    ...
    public NbtCompound writeNbt(NbtCompound nbt) {
        ...
        players.forEach((uuid, playerData) -> {
            ...
            playerNbt.putDouble(ThirstManager.NBT_VALUE, playerData.thirstValue);
